...
with app.app_context():
    ...
    # Create User
    u1 = User(name='Maureen', email='maureen@gmail.com')
    u2 = User(name='Abiud', email='abiud@gmail.com' )
    u3 = User(name='Kevin', email='kevin@gmail.com' )
    u4 = User(name='Nellie', email='nellie@gmail.com')
    u5 = User(name='Mitchelle', email='mitchelle@gmail.com')
    u6 = User(name='Tony', email='tony@gmail.com' )
    u7 = User(name='Kipkorir', email='kipkorir@gmail.com' )
    u8 = User(name='Augo', email='augo@gmail.com' )
    u9 = User(name='Kimberly', email='kimberly@gmail.com')
